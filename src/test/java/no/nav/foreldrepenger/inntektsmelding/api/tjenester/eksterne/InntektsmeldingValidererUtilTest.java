...
class InntektsmeldingValidererUtilTest {
    ...
    void skal_avvise_duplikate_unike_årsaker() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.NyStilling, STARTDATO.minusDays(5), null, null),
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.NyStilling, STARTDATO.minusDays(3), null, null)
        );
    ...
    void skal_avvise_ny_stilling_uten_fom() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.NyStilling, null, null, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
    ...
    void skal_avvise_ny_stillingsprosent_uten_fom() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.NyStillingsprosent, null, null, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).hasValue(EksponertFeilmelding.AARSAK_KREVER_FRA_DATO);
    }
    ...
    void skal_avvise_varig_lønnsendring_uten_fom() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.VarigLoennsendring, null, null, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).hasValue(EksponertFeilmelding.AARSAK_KREVER_FRA_DATO);
    }
    ...
    void skal_godkjenne_ny_stilling_med_fom() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.NyStilling, STARTDATO.minusDays(10), null, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).isEmpty();
    }
    ...
    void skal_avvise_varig_lønnsendring_fom_etter_startdato() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.VarigLoennsendring, STARTDATO.plusDays(1), null, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
    ...
    void skal_avvise_varig_lønnsendring_fom_lik_startdato() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.VarigLoennsendring, STARTDATO, null, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).hasValue(EksponertFeilmelding.FRA_DATO_FOER_STARTDATO);
    }
    ...
    void skal_godkjenne_varig_lønnsendring_fom_før_startdato() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.VarigLoennsendring, STARTDATO.minusDays(10), null, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).isEmpty();
    }
    ...
    void skal_godkjenne_ferietrekk_uten_datoer() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.Ferietrekk, null, null, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).isEmpty();
    }
    ...
    void skal_godkjenne_mangelfull_rapportering_uten_datoer() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.MangelfullRapporteringAordning, null, null, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).isEmpty();
    }
    ...
    void skal_godkjenne_inntekt_ikke_rapportert_uten_datoer() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.InntektIkkeRapportertEndaAordning, null, null, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).isEmpty();
    }
    ...
    void skal_returnere_feil_fra_endringsårsak_validering() {
        var request = lagRequest(YtelseType.FORELDREPENGER,
            ...
            List.of(), new InntektsmeldingRequest.InntektInfo(DEFAULT_BELØP, List.of(new InntektsmeldingRequest.InntektInfo.Endringsaarsak(
                InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.NyStilling, null, null, null))));
