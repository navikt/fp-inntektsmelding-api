...
class InntektsmeldingValidererUtilTest {
    ...
    private InntektsmeldingRequest.Naturalytelse lagNaturalytelse(LocalDate fom, LocalDate tom) {
        return new InntektsmeldingRequest.Naturalytelse(InntektsmeldingRequest.Naturalytelse.Naturalytelsetype.ELEKTRONISK_KOMMUNIKASJON, DEFAULT_BELØP,
            fom, tom);
    }
    ...
    void skal_avvise_duplikate_unike_årsaker() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.NY_STILLING, STARTDATO.minusDays(5), null, null),
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.NY_STILLING, STARTDATO.minusDays(3), null, null)
        );
    ...
    void skal_godkjenne_duplikate_ikke_unike_årsaker() {
        ...
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.FERIE, STARTDATO, STARTDATO.plusDays(5), null),
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.FERIE, STARTDATO.plusDays(10), STARTDATO.plusDays(15), null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).isEmpty();
    }
    ...
    void skal_godkjenne_duplikate_permisjon_årsaker() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.PERMISJON, STARTDATO, STARTDATO.plusDays(5), null),
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.PERMISJON, STARTDATO.plusDays(10), STARTDATO.plusDays(15), null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).isEmpty();
    }
    ...
    void skal_avvise_duplikat_bonus() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.BONUS, null, null, null),
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.BONUS, null, null, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).hasValue(EksponertFeilmelding.DUPLIKATER_IKKE_TILATT);
    ...
    void skal_avvise_tariffendring_uten_fom() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.TARIFFENDRING, null, null, STARTDATO)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
    ...
    void skal_avvise_tariffendring_uten_ble_kjent_fom() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.TARIFFENDRING, STARTDATO, null, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).hasValue(EksponertFeilmelding.KREVER_FRA_OG_BLE_KJENT_DATO);
    }
    ...
    void skal_avvise_ny_stilling_uten_fom() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.NY_STILLING, null, null, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
    ...
    void skal_avvise_ny_stillingsprosent_uten_fom() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.NY_STILLINGSPROSENT, null, null, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).hasValue(EksponertFeilmelding.AARSAK_KREVER_FRA_DATO);
    }
    ...
    void skal_avvise_varig_lønnsendring_uten_fom() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.VARIG_LOENNSENDRING, null, null, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).hasValue(EksponertFeilmelding.AARSAK_KREVER_FRA_DATO);
    }
    ...
    void skal_godkjenne_ny_stilling_med_fom() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.NY_STILLING, STARTDATO.minusDays(10), null, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).isEmpty();
    }
    ...
    void skal_avvise_varig_lønnsendring_fom_etter_startdato() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.VARIG_LOENNSENDRING, STARTDATO.plusDays(1), null, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
    ...
    void skal_avvise_varig_lønnsendring_fom_lik_startdato() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.VARIG_LOENNSENDRING, STARTDATO, null, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).hasValue(EksponertFeilmelding.FRA_DATO_FOER_STARTDATO);
    }
    ...
    void skal_godkjenne_varig_lønnsendring_fom_før_startdato() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.VARIG_LOENNSENDRING, STARTDATO.minusDays(10), null, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).isEmpty();
    }
    ...
    void skal_avvise_ferie_uten_fom() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.FERIE, null, STARTDATO.plusDays(5), null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
    ...
    void skal_avvise_ferie_uten_tom() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.FERIE, STARTDATO, null, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).hasValue(EksponertFeilmelding.AARSAK_KREVER_FRA_OG_TIL_DATO);
    }
    ...
    void skal_avvise_permittering_uten_datoer() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.PERMITTERING, null, null, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).hasValue(EksponertFeilmelding.AARSAK_KREVER_FRA_OG_TIL_DATO);
    }
    ...
    void skal_avvise_sykefravær_uten_tom() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.SYKEFRAVAER, STARTDATO, null, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).hasValue(EksponertFeilmelding.AARSAK_KREVER_FRA_OG_TIL_DATO);
    }
    ...
    void skal_godkjenne_permisjon_med_fom_og_tom() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.PERMISJON, STARTDATO, STARTDATO.plusDays(10), null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).isEmpty();
    }
    ...
    void skal_avvise_fom_etter_tom_for_endringsårsaker() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.FERIE, STARTDATO.plusDays(10), STARTDATO, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).hasValue(EksponertFeilmelding.FRA_DATO_ETTER_TOM);
    }
    ...
    void skal_godkjenne_fom_lik_tom() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.FERIE, STARTDATO, STARTDATO, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).isEmpty();
    }
    ...
    void skal_avvise_overlappende_perioder_for_endringsårsaker() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.FERIE, STARTDATO, STARTDATO.plusDays(10), null),
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.PERMISJON, STARTDATO.plusDays(5), STARTDATO.plusDays(15), null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).hasValue(EksponertFeilmelding.OVERLAPP_I_PERIODER);
    }
    ...
    void skal_godkjenne_ikke_overlappende_perioder_for_endringsårsaker() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.FERIE, STARTDATO, STARTDATO.plusDays(5), null),
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.PERMISJON, STARTDATO.plusDays(7), STARTDATO.plusDays(15), null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).isEmpty();
    }
    ...
    void skal_godkjenne_nyansatt_uten_datoer() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.NYANSATT, null, null, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).isEmpty();
    }
    ...
    void skal_godkjenne_ferietrekk_uten_datoer() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.FERIETREKK_ELLER_UTBETALING_AV_FERIEPENGER, null, null, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).isEmpty();
    }
    ...
    void skal_godkjenne_mangelfull_rapportering_uten_datoer() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.MANGELFULL_RAPPORTERING_AORDNING, null, null, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).isEmpty();
    }
    ...
    void skal_godkjenne_inntekt_ikke_rapportert_uten_datoer() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.INNTEKT_IKKE_RAPPORTERT_ENDA_AORDNING, null, null, null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).isEmpty();
    }
    ...
    void skal_ikke_godkjenne_flere_ulike_årsaker_hvor_en_har_ugyldig_dato() {
        var årsaker = List.of(
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.NY_STILLING, STARTDATO.minusDays(5), null, null),
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.BONUS, null, null, null),
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.FERIE, STARTDATO.minusDays(5), STARTDATO.plusDays(5), null),
            lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.FERIE, STARTDATO.minusDays(4), STARTDATO.plusDays(5), null)
        );
        var result = InntektsmeldingValidererUtil.validerEndringsårsaker(årsaker, STARTDATO);
        assertThat(result).hasValue(EksponertFeilmelding.OVERLAPP_I_PERIODER);
    }

    private InntektsmeldingRequest.InntektInfo.Endringsaarsak lagEndringsårsak(InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType årsak,
                                                                               LocalDate fom, LocalDate tom, LocalDate bleKjentFom) {
        return new InntektsmeldingRequest.InntektInfo.Endringsaarsak(årsak, fom, tom, bleKjentFom);
    }
    ...
    void skal_returnere_feil_fra_endringsårsak_validering() {
        var request = lagRequest(YtelseType.FORELDREPENGER,
            new InntektsmeldingRequest.Refusjon(DEFAULT_BELØP, List.of()),
            List.of(), new InntektsmeldingRequest.InntektInfo(DEFAULT_BELØP, List.of(new InntektsmeldingRequest.InntektInfo.Endringsaarsak(
                InntektsmeldingRequest.InntektInfo.Endringsaarsak.EndringsaarsakType.NY_STILLING, null, null, null))));
