package no.nav.k9.inntektsmelding.api.server;
...
import no.nav.k9.inntektsmelding.api.server.app.api.ApiConfig;
import no.nav.k9.inntektsmelding.api.server.app.internal.InternalApiConfig;
...
public class JettyServer {
    ...
    private static class JsonErrorHandler extends ErrorHandler {
        ...
        public boolean handle(Request request, Response response, Callback callback) {
            ...
            var errorResponse = new ErrorResponse(HttpStatus.getCode(code) + "ERROR",  "[%s] %s".formatted(code, message));
